...
namespace Telegram_KrotoBot
{
    public class HelpClass
    {
        public static void CaseHelpMethod()
        {
            ...
            Console.WriteLine("\t/deleteuser - удалить пользователя из чёрного списка (агрумент - id пользователя или его никнейм с @)"); 
            ...
            Console.WriteLine("\t/stoptrack - остановить работу бота без выхода из консоли");
